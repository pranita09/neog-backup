...
// Your code here
const findToyotaCar1 = arrayOfCars => arrayOfCars.find((car)=> car.make === "Toyota" && car.year > 2010); 
const findToyotaCar = arrayOfCars => arrayOfCars.find(({make, year})=> make === "Toyota" && year > 2010); 
