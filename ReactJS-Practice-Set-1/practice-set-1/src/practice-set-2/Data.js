...
export const content = "React is a JavaScript library for building user interfaces.";
  
export const heading = "About Me";
export const name = "Pranita"; // you can put your name
export const learning = "I am learning React JS currently at neoG Camp.";
